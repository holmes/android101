...
public class WalletModule {
  ...
  @Provides @Singleton ApiHeaders provideApiHeaders() {
  ...
  /** Global Gson instance which allows for centralized (de)serialization configuration. */
  @Provides @Singleton
   ...
   */
  @Provides @Singleton
  RestAdapter provideRestAdapter(OkHttpClient client, ApiHeaders headers, Gson gson) {
    ...
    // Retrofit will create a GsonConverter by default with a new Gson instance. Use ours instead.
  ...
  @Provides @Singleton WalletService provideWalletService(RestAdapter restAdapter) {
